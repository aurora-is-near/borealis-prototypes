...
func (m *Signature_ED25519) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.H512Value) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H512Value)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Signature_SECP256K1) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.H520Value) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H520Value)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_ED25519) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.H256Value) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256Value)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
