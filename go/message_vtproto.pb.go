...
func (m *Message_GetAccountStatusRequest) CloneVT() isMessage_Payload {
	...
	r := new(Message_GetAccountStatusRequest)
	r.GetAccountStatusRequest = m.GetAccountStatusRequest.CloneVT()
	return r
}
...
func (m *Message_GetAccountStatusResponse) CloneVT() isMessage_Payload {
	...
	r := new(Message_GetAccountStatusResponse)
	r.GetAccountStatusResponse = m.GetAccountStatusResponse.CloneVT()
	return r
}
...
func (m *Message) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if oneof, ok := m.Payload.(*Message_RpcRequest); ok {
				if err := oneof.RpcRequest.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &rpc.RpcMessage{}
		...
		case 5:
			...
			if oneof, ok := m.Payload.(*Message_RpcResponse); ok {
				if err := oneof.RpcResponse.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &rpc.RpcMessage{}
		...
		case 6:
			...
			if oneof, ok := m.Payload.(*Message_GetAccountStatusRequest); ok {
				if err := oneof.GetAccountStatusRequest.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &get_account_status.GetAccountStatusRequest{}
		...
		case 7:
			...
			if oneof, ok := m.Payload.(*Message_GetAccountStatusResponse); ok {
				if err := oneof.GetAccountStatusResponse.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &get_account_status.GetAccountStatusResponse{}
