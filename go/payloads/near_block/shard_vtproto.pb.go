...
func (m *ChunkHeaderView) CloneVT() *ChunkHeaderView {
	...
	r := &ChunkHeaderView{
		EncodedLength:  m.EncodedLength,
		HeightCreated:  m.HeightCreated,
		HeightIncluded: m.HeightIncluded,
		ShardId:        m.ShardId,
		GasUsed:        m.GasUsed,
		GasLimit:       m.GasLimit,
...
func (m *PartialIndexerBlockHeaderView) CloneVT() *PartialIndexerBlockHeaderView {
	...
	r := &PartialIndexerBlockHeaderView{
		Height:                m.Height,
		ChunksIncluded:        m.ChunksIncluded,
		Timestamp:             m.Timestamp,
		TimestampNanosec:      m.TimestampNanosec,
		Signature:             m.Signature.CloneVT(),
		LatestProtocolVersion: m.LatestProtocolVersion,
	}
...
func (m *ChunkHeaderView) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.H256TxRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256TxRoot)))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.H256OutgoingReceiptsRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256OutgoingReceiptsRoot)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.U128BalanceBurnt) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.U128BalanceBurnt)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.U128ValidatorReward) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.U128ValidatorReward)))
		i--
		dAtA[i] = 0x62
	}
	if m.GasLimit != 0 {
	...
	if m.HeightIncluded != 0 {
		i = encodeVarint(dAtA, i, uint64(m.HeightIncluded))
		i--
		dAtA[i] = 0x40
	}
	if m.HeightCreated != 0 {
		i = encodeVarint(dAtA, i, uint64(m.HeightCreated))
		i--
		dAtA[i] = 0x38
	}
	if m.EncodedLength != 0 {
		i = encodeVarint(dAtA, i, uint64(m.EncodedLength))
		i--
		dAtA[i] = 0x30
	}
	if len(m.H256EncodedMerkleRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256EncodedMerkleRoot)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.H256PrevStateRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256PrevStateRoot)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.H256OutcomeRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256OutcomeRoot)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.H256PrevBlockHash) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256PrevBlockHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.H256ChunkHash) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256ChunkHash)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PartialIndexerBlockHeaderView) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LatestProtocolVersion != 0 {
		i = encodeVarint(dAtA, i, uint64(m.LatestProtocolVersion))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd8
	...
	if m.H256EpochSyncDataHash != nil {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256EpochSyncDataHash)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
	...
	if len(m.H256BlockMerkleRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256BlockMerkleRoot)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc2
	...
	if len(m.H256NextBpHash) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256NextBpHash)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xba
	...
	if len(m.H256LastDsFinalBlock) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256LastDsFinalBlock)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	...
	if len(m.H256LastFinalBlock) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256LastFinalBlock)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if len(m.U128TotalSupply) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.U128TotalSupply)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
	...
	if m.BlockOrdinal != nil {
		i = encodeVarint(dAtA, i, uint64(*m.BlockOrdinal))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if len(m.U128GasPrice) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.U128GasPrice)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.ChunkMask) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ChunkMask)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	...
	if len(m.H256RandomValue) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256RandomValue)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	...
	if m.TimestampNanosec != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TimestampNanosec))
		i--
		dAtA[i] = 0x78
	}
	if m.Timestamp != 0 {
	...
	if len(m.H256ChallengesRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256ChallengesRoot)))
		i--
		dAtA[i] = 0x6a
	}
	if m.ChunksIncluded != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ChunksIncluded))
		i--
		dAtA[i] = 0x60
	}
	if len(m.H256OutcomeRoot) > 0 {
	...
	if len(m.H256ChunkTxRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256ChunkTxRoot)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.H256ChunkHeadersRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256ChunkHeadersRoot)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.H256ChunkReceiptsRoot) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256ChunkReceiptsRoot)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.H256PrevStateRoot) > 0 {
	...
	if len(m.H256PrevHash) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256PrevHash)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.H256Hash) > 0 {
	...
	if len(m.H256NextEpochId) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256NextEpochId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.H256EpochId) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.H256EpochId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.PrevHeight != nil {
		i = encodeVarint(dAtA, i, uint64(*m.PrevHeight))
		i--
		dAtA[i] = 0x10
	}
	if m.Height != 0 {
...
func (m *ChunkHeaderView) SizeVT() (n int) {
	...
	if m.EncodedLength != 0 {
		n += 1 + sov(uint64(m.EncodedLength))
	}
	if m.HeightCreated != 0 {
		n += 1 + sov(uint64(m.HeightCreated))
	}
	if m.HeightIncluded != 0 {
		n += 1 + sov(uint64(m.HeightIncluded))
	}
	if m.ShardId != 0 {
		n += 1 + sov(uint64(m.ShardId))
	}
...
func (m *PartialIndexerBlockHeaderView) SizeVT() (n int) {
	...
	if m.ChunksIncluded != 0 {
		n += 1 + sov(uint64(m.ChunksIncluded))
	}
	...
	if m.TimestampNanosec != 0 {
		n += 1 + sov(uint64(m.TimestampNanosec))
	}
	...
	if len(m.ChunkMask) > 0 {
		n += 2 + sov(uint64(len(m.ChunkMask))) + len(m.ChunkMask)*1
	}
	...
	if m.LatestProtocolVersion != 0 {
		n += 2 + sov(uint64(m.LatestProtocolVersion))
	}
	n += len(m.unknownFields)
	return n
}
